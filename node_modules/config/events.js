    ...
    events.find({
        ...
        if (len == 0) {
            ...
            user.find({
                ...
                users[0].adminEventsName.push(eventAdminName);
            ...
            for (var requestEvents in eventRequestsName) {
                console.log("requestMembers" +eventRequestsName[requestEvents]);
                user.find({
                    email: eventRequestsName[requestEvents]
                }, function(err, users) {
...
exports.getEventDetails = function(eventToken,callback) {
     ...
     events.find({
                ...
                callback({
                    ...
                    'eventAdmin':events[0].eventAdmin,
